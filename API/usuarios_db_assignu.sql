...
--
-- Host: localhost    Database: asingu_usuarios_bd
-- ------------------------------------------------------
...
CREATE TABLE `alumno` (
  ...
  KEY `idGradoEstudios_idx` (`idGradoEstudios`),
  CONSTRAINT `idGradoEstudios` FOREIGN KEY (`idGradoEstudios`) REFERENCES `grado_estudios` (`idGradoEstudios`)
...
CREATE TABLE `docente` (
  ...
  UNIQUE KEY `correo_UNIQUE` (`correo`),
  UNIQUE KEY `contrasenia_UNIQUE` (`contrasenia`),
  KEY `idGradoProfesional_idx` (`idGradoProfesional`),
  CONSTRAINT `idGradoProfesional` FOREIGN KEY (`idGradoProfesional`) REFERENCES `grado_profesional` (`idGradoProfesional`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-05-17 18:18:51
